...
\begin{enumerate}
	...
	\enter\hfill [1] \begin{footnotesize}(\bo{\texttt{80 Bh}, 80 Bh, 76 Ch, 75 Ch, 74 Ch, 73 Ch, 72 Ch}, \texttt{81 Ba}, 80 Ba, 79 Ba, 75 Ash)\end{footnotesize} [2] \begin{footnotesize}(\bo{\texttt{79 Bh}})\end{footnotesize}
	...
	\lb Explain with examples. \hfill [3] (79 Ba) [4] (\bo{74 Ch, 73 Ch, 72 Ch})
...
\begin{enumerate}
	...
	\lb Explain w/ suitable example.\hfill [3] (\bo{\texttt{80 Bh}}, 75 Ash) [5] (\texttt{80 Ba})
