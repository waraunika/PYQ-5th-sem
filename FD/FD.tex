...
% \fancyfoot[L]{For contact \& queries: waraunika2956@gmail.com, 079bei008.arun@pcampus.edu.np}
% \fancyfoot[R]{\thepage}
...
\section{Sensitivity}
	...
	\subsection{Sensitivity and importance of sensitivity analysis}
		\begin{enumerate}
			\item What is sensitivity? \hfill [1] (\bo{75 Ch, 74 Ch, 73 Ch}, 81 Ba, 73 Shr, 72 Ka, 71 Shr, 70 Asa)

			\item What is sensitivity analysis in filter design? \hfill [1] (\bo{\texttt{81 Bh}})
			
			\item What is importance of sensitivity in fitler deisgn? \hfill [1] (71 Shr)
	...
	\subsection{Definition of single parameter sensitivity}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item What is signal parameter sensitivity. (\textit{Assume single}) \hfill [1] (\bo{70 Ch})
		\end{enumerate}
	...
	\subsection{Sensitivity properties of biquads}
		\begin{enumerate}
			...
			\enter\hfill [3] (\bo{73 Ch}, 72 Ka, 70 Asa) [4] (81 Ba) [5] (\texttt{81 Ba, 80 Ba})
			\lb for center frequency w.r.t all elements. \hfill [4] (\bo{76 Ch, 75 Ch, 72 Ch, 70 Ch}) [5] (\bo{79 Bh})

			\item Perform the sensitivity analysis of quality factor (Q) in Tow Thomas low pass biquad.
			\enter\hfill [2] (71 Shr) [4] (\bo{\texttt{79 Bh}}, 80 Ba, 79 Ba, 73 Shr) [5] (\bo{\texttt{81 Bh}}) [6] (\bo{81 Bh})
