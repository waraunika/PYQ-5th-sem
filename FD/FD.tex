	...
	\subsection{Second order active sections (biquads)}
		...
		\subsubsection{Tow-Thomas biquad circuit, design of active filter using TowThomas biquad}
			\begin{enumerate}
				...
				\item Draw a neat and clean circuit diagram of Tow-Thomas LPF and derive its transfer function. Design a LPF using Tow-Thomas Biquad circuit which has poles at 1000 $\pm$ 8994.03 j and DC gain of 1.89. Use 0.01$\mu$F capacitor in your design. \hfill [9] (\bo{71 Ch})

				\item Draw the circuit diagram and derive transfer function of Tow Thomas Biquad circuit. Design a low pass filter using Tow-Thomas Biquad circuit with poles at -500 $\pm$ j 2449.49 and dc gain of 2. The final circuit should consist capacitors of value 0.1$\mu$F. \hfill [3+5] (\bo{70 Ch})

				\item Draw the circuit diagram of Tow-Thomas LPF and derive its transfer function. Design a second order LPF using Tow-Thomas biquad circuit having poles at -750 $\pm$ j 661.44 and dc gain of 2. Use capacitor of value 0.01$\mu$F in your design. \hfill [4+4] (\bo{69 Ch})
				...
				\item Draw the circuit diagram of Tow-Thomas LPF and derive its transfer function. Design a second order Butterworth LPF having half power frequency of 5 kHz using Tow-Thomas biquad circuit. Your final ckt should have all capacitors of 0.001$\mu$F. \hfill [4+4] (71 Shr)
		...
		\subsubsection{Sallen-Key biquad circuit and Multiple-feedback biquad (MFB) circuit}
			\begin{enumerate}
				...
				\item Draw the circuit diagram of Sallen-Key LPF and derive its transfer function. Design second order butterworth LPF using half power frequency of 10Khz using Sallen Key biquad. In your final design the value of capacitor must be 0.01$\mu$F and feedback resistors should also be equal. \hfill [5+4] (72 Ka)

				\item Draw the circuit diagram of Sallen-Key LPF and derive its transfer function. Design a second order Butterworth LPF having half power frequency of 4kHz using Sallen-Key circuit. Your final circuit should have all capacitors of 0.01$\mu$F. Perform gain compensation if necessary. \hfill [4+4] (70 Asa)
