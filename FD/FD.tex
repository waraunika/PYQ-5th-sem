...
\item Calculate the minimum order of Butterworth filter with the following specifications:\hfill[3] (\bo{\texttt{81 Bh}})\\
...
\begin{enumerate}
	...
	\item Obtain a bandpass filter having \w\textsubscript{1} = 100 rad/s and \w\textsubscript{2} = 1000 rad/s from following LPF at normalized frequency. \hfill [4] (74 Ash)\\
	\includegraphics[width=4in]{fd_8}
	
	\item The ckt given below is an LPF having passband frequency of 1 rad/s. Obtain a bandpass filter having \w\textsubscript{0} = 2000 rad/s and B = 400 rad/s. \hfill [3] (\bo{71 Ch})\\
...
\begin{enumerate}
	...
	\item Following circuit is a low pass filter having $\alpha_p$ = 1dB and \w\textsubscript{p} = 1 rad/s. Obtain a bandpass filter \w\textsubscript{0} = 400 rad/s and bandwidth of 150 rad/s. \hfill [4] (\bo{80 Bh})\\
...
\begin{enumerate}[noitemsep, topsep=0pt]
	\item Write the properties of lossless one port network. \hfill [2] (\bo{81 Bh})
...
\begin{enumerate}
	...
	\item Define transmission zeros in two port network.\hfill [1] (\bo{\texttt{80 Bh}, 80 Bh}, \texttt{81 Ba}, 80 Ba, 79 Ba) [2] (\bo{\texttt{79 Bh}})
	
	\item How can zeros of transmission be realized in ckts? Explain with suitable diagrams.
	\enter\hfill [4] (\bo{\texttt{79 Bh}}) [5] (\texttt{81 Ba})
...
\begin{enumerate}
	...
	\item What is zero shifting by partial removal of pole? Explain w/ suitable example.\hfill [3] (\bo{\texttt{80 Bh}})
