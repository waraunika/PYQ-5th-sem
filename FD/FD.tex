...
\section{Introduction}
	...
	\subsection{Kinds of filters in terms of frequency response}
		\begin{enumerate}
			...
			\item Define the following terms with the help of illustrations: Passband, Stopband, Transition band, Roll-off and bandwidth. \hspace{12.2cm} [4] (\bo{79 Bh})
...
\section{Design of High-Order Active Filters}
    ...
    1. What are the different techniques of designing higher order active filters? Discuss briefly. \hfill [4] (70 Asa)
