...
\section{Computer Arithmetic}
	...
	\subsection{Multiplication Algorithm}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item Explain booth's algorithm. \hfill [4] (\bo{\texttt{80 Bh}}) [5] (\bo{76 Ch})
	...
	\subsection{Division Algorithm}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item Compare restoring division algorithm with non restoring algorithm. \hfill [6] (\bo{\texttt{80 Bh}}, 76 Ash, 75 Ash)
			\lb with example. \hfill [6] (\bo{76 Ch})
