...
\section{Computer Arithmetic}
	...
	\subsection{Multiplication Algorithm}
		\begin{enumerate}[noitemsep, topsep=0pt]
			\item Draw a flowchart for Booth's multiplication algorithm for signed multiplication.
			\enter\hfill [4] (\texttt{78 Ka}) [5] (\bo{\texttt{81 Bh}})
			...
			\item Explain floating point multiplication process with example. \hfill [3] (\texttt{82 Ba})
	...
	\subsection{Division Algorithm}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\lb with example. \hfill [3] (\texttt{82 Ba})
...
\section{Memory System}
	...
	\subsubsection{Replacement algorithm}
		\begin{enumerate}
			...
			\lb Explain th LRU replacement algorithm with example. \hfill [5] (\texttt{82 Ba})
