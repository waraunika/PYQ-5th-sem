...
\section{Data Link Layer}
	...
	\subsection{Networks: FDDI, ALOHA, VLAN, CSMA/CD, IEEE 802.3(Ethernet), 802.4(Token Bus), 802.5(Token Ring), and 802.1(Wireless LAN)}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item How does CSMA-CD works? Explain. \hfill [4] (\bo{76 Bh}) [6] (\bo{79 Ch})
...
\section{Network Layer}
	...
	\subsection{Subnetting}
		\begin{enumerate}
			\item Explain with exampele, the use of sub-netting showing network address, broadcast address and sub-net mask. \hfill [6] (\bo{73 Bh})
	...
	\subsection{Routing Protocols: RIP, OSPF, BGP, Unicast and multicast routing protocols}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item Explain the working process of OSPF with an example. \hfill [6] (\bo{70 Bh})
...
\section{Transport Layer}
	...
	\subsection{Congestion control algorithm: Token Bucket and Leaky Bucket Transport Layer}
		\begin{enumerate}
			...
			\item Explain Token Bucket algorithm. \hfill [4] (\bo{72 Ch})
		\end{enumerate}
