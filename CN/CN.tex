...
\section{Physical Layer}
	...
	\subsection{Transmission Media: TP, Coaxial, Fiber Optic, LoS, Satellite}
		\begin{enumerate}[noitemsep, topsep=0pt]
    		...
    		\lb Compare different types of guided transmission media with appropriate figures. \hfill [6] (\texttt{80 Ba})
	...
	\subsection{Circuit switching and Multiplexing}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\lb What do you mean by data switching? \hfill [2] (\bo{70 Ch})
	...
	\subsection{Digital Telephony and ISDN}
		\begin{enumerate}[noitemsep, topsep=0pt]			
			...
			\lb with interface and functional group. \hfill [6] (76 Ash)
			\lb with architecture. \hfill [5] (75 Ash)
...
\section{Data Link Layer}
	...
	\subsection{The Medium Access Sub-layer}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item (Assumed) Though we have MAC address, why do we use IP address to represent the host in networks? Explain your answer. \hfill [3] (\bo{72 Ch})
	...
	\subsection{Networks: ALOHA, VLAN, CSMA/CD, IEEE 802.3(Ethernet), 802.4(Token Bus), 802.5(Token Ring), and 802.11(Wireless LAN), FDDI}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item Explain Ethernet frame with function of each field. \hfill [5] (\bo{77 Ch})
    			...
    			\lb Explain various cabling techniques used in IEEE 802.3 standard. \hfill [4] (71 Ma)
...
\section{Network Layer}
	...
	\subsection{Internetworking and devices: Repeaters, Hubs, Bridges, Switches, Router, Gateway}
		...
		\end{enumerate}
	\subsection{IP Addressing and DHCP}
		\begin{enumerate}[noitemsep, topsep=0pt]
...
\section{Transport Layer}
	...
	\subsection{Connection establishment, Connection release}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\lb Explain connection management of TCP with necessary figures. \hfill [6] (\bo{77 Ch})
	...
	\subsection{Congestion control algorithm: Token Bucket and Leaky Bucket Transport Layer}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item What are the techniques for congestion control? \hfill [3] (\bo{74 Bh})
...
\section{Introduction to IPV6}
	...
	\subsection{IPv6- Advantages}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\lb Why the world has decided to migrate to new internet addressing scheme IPV6? \hfill [3] (\bo{73 Ch})
...
\section{Network Security}
	...
	\subsection{Properties of secure communication}
		\begin{enumerate}[noitemsep, topsep=0pt]
			\item What is network security? \hfill [3] (76 Ba)
	...
	\subsection{Principles of cryptography, DES Algorithm, D-H Algorithm}
		\begin{enumerate}[noitemsep, topsep=0pt]
