...
\begin{enumerate}[noitemsep, topsep=0pt]
	\item How does data link apply flow control technique in network communication? Explain with example. \hfill [6] (\bo{79 Ch})
\end{enumerate}
\subsection{Framing}
\begin{enumerate}[noitemsep, topsep=0pt]
...
\begin{enumerate}[noitemsep, topsep=0pt]
	...
	\item How does CSMA-CD works? Explain. \hfill [6] (\bo{79 Ch})
