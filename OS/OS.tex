...
\section{Introduction}
	...
	\item Write short notes on Virtual Machine. \hfill [3] (\bo{\texttt{80 Bh}})
...
\section{Process Management}
	...
	\subsection{Numericals}
		\begin{enumerate}
			...
			\includegraphics[width=3.5in]{./pics/os_23}\\
...
\section{Memory Management}
	...
	\subsection{Memory Allocation Techniques}
		\begin{enumerate}
			...
			\item What is DMA? \hfill [2] (\bo{79 Ch})
			...
			\item (Assumed) What is associative memory and thrashing? \hfill [1+1] (\bo{77 Ch})
		\end{enumerate}
		...
		\subsubsection{Non-Contiguous: Paging/Segmentation}
			\begin{enumerate}
				...
				\item Explain how a logical address is mapped to a physical address in paging. \hfill [4] (\bo{\texttt{81 Bh}})
	...
	\subsection{Demand Paging}
		\begin{enumerate}
			\item What is Demand paging? \hfill [1] (\bo{80 Ch, 77 Ch})
		\end{enumerate}
	...
	\subsection{Page Replacement Algorithms}
		\begin{enumerate}
			...
			\item Define page fault and demand paging. \hfill [4] (\bo{78 Ch})
		\end{enumerate}

	\subsection{Allocation of Frames}
	\subsection{Thrashing}
		\begin{enumerate}
			\item Write short notes on: Thrashing. \hfill [3] (\bo{\texttt{81 Bh, 80 Bh}})
		\end{enumerate}
	\subsection{Numericals}
		\begin{enumerate}
...
\section{File Systems}
	...
	\subsection{File: Name, Structure, Types, Access, Attribute, Operations}
		\begin{enumerate}
			\item Describe File System for operating system. \hfill [4] (\bo{80 Ch})

			\item Define file system and list out some attributes of file. \hfill [3] (\bo{77 Ch})

			\item What is file attribute? \hfill [1] (\bo{79 Ch}, \texttt{81 Ba})
	...
	\subsection{File System Implementation}
		...
		\subsubsection{Implementing File: Contiguous Allocation, Link List Allocation, Link List Allocation with Table, Inode}
			\begin{enumerate}
				\item Explain various ways of implementing file system. \hfill [6] (\bo{\texttt{79 Bh}})

				\item Explain the file allocation methods with its adv and disadv. \hfill [5] (\texttt{81 Ba}) [6] (\bo{79 Ch})

				\item Explain I-node approach of file implementation with its adv and disadv. \hfill [5] (\bo{\texttt{81 Bh}})
				...
				\lb Differentiate Compaction and Coalescing. \hfill [2] (\bo{77 Ch}) [4] (\bo{\texttt{79 Bh}})
	...
	\subsection{Example File Systems: CD ROM file system, MS-DOS file system, Unix File system}
		\begin{enumerate}
			\item Write short notes on: UNIX File System. \hfill [5] (\bo{77 Ch})
		\end{enumerate}
...
\section{I/O Management and Disk Scheduling}
	...
	\subsection{Principles of I/O software}
		\begin{enumerate}
			...
			\item What are the disadv of Programmed IO? \hfill [2] (\bo{77 Ch})
		\end{enumerate}
...
\section{Deadlock}
	...
	\subsection{Principles of deadlock}
		\begin{enumerate}
			...
			\item Explain necessary conditions for deadlock. \hfill [2] (\bo{80 Ch}, \texttt{81 Ba})
	...
	\subsection{Numericals}
		\begin{enumerate}
			...
			\end{tabular}\\
			The available resources are A: 3, B: 2, and C: 2. Is the state safe? If so, show the safe execution of processes. \hfill [6] (\bo{78 Ch}) [7] (\texttt{80 Ba})
...
\section{Security}
	...
	\subsection{Basics of Cryptography}
		\begin{enumerate}
			...
			\item Write short notes on Caesar Cipher and Access Control Lists. \hfill [3+3] (\bo{\texttt{79 Bh}})

			\item Write short notes on: Cryptography. \hfill [2.5] (\texttt{80 Ba})

			\item Write short notes on: Public Key Cryptography \hfill [4] (\bo{78 Ch})
		\end{enumerate}

	\subsection{Protection Mechanisms}
		\begin{enumerate}
			\item (Assumed) Write short notes: Protection Domain \hfill [3] (\bo{80 Ch})
	...
	\subsection{Access Control Lists And OS Support}
		\begin{enumerate}
			\item What is ACL? \hfill [2] (\bo{\texttt{81 Bh, 80 Bh}, 79 Ch, 77 Ch}, \texttt{81 Ba}) [2.5] (\texttt{80 Ba})

			\item How is ACL different from the capabilities list? \hfill [2] (\bo{\texttt{81 Bh}})

			\item Describe how Access Control List is used. \hfill [3] (\bo{80 Ch}) [4] (\bo{78 Ch})
		\end{enumerate}
...
\section{System administration}
	...
	\subsection{Administration Tasks}
		\begin{enumerate}
			\item What are the roles of a system administrator? \hfill [2.5] (\texttt{81 Ba}) [4] (\bo{\texttt{81 Bh}}) [5] (\bo{80 Ch}) [6] (\bo{\texttt{80 Bh}})
			...
			\lb What is the significance of system administration? Describe the roles and responsibilities of system administrator of Insurance Company. \hfill [4] (\bo{\texttt{79 Bh}})
		\end{enumerate}

	\subsection{User Account Management}
		\begin{enumerate}
			\item How is a special user different from a general user? Explain. \hfill [2] (\bo{\texttt{81 Bh}})
