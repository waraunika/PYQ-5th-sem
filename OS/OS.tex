...
\section{Process Communication and Synchronization}
	...
	\subsection{Critical Region}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item Why is it important for a thread to execute a critical section as quickly as possible?
			\enter\hfill [3] (\bo{73 Bh})
		\end{enumerate}
...
\section{Deadlock}
	...
	\subsection{Principles of deadlock}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\enter\hfill [2] (\bo{80 Ch}, \texttt{81 Ba}, 75 Ba) [3] (\bo{74 Bh}) [4] (\bo{72 Ash, 69 Bh}, 71 Ma)
...
\section{Security}
	...
	\subsection{Protection Mechanisms}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\enter\hfill [1] (\bo{79 Ch}) [2] (\bo{\texttt{80 Bh}, 77 Ch})
	...
	\subsection{Access Control Lists And OS Support}
		\begin{enumerate}[noitemsep, topsep=0pt]
			\item What is ACL?
			\enter\hfill [2] (\bo{\texttt{81 Bh, 80 Bh}, 79 Ch, 77 Ch, 70 Bh}, \texttt{81 Ba}) [2.5] (\bo{69 Ch}, \texttt{80 Ba}) [3] (\bo{68 Bh})
