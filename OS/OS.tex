...
\section{Process Management}
	...
	\subsection{Numericals}
		\begin{enumerate}
			\item Schedule the following processes according to SRTN and priority preemptive algorithm to calculate average TAT and WT. Here, the process with the lowest value has the highest priority. \hfill [8] (\texttt{82 Ba})\\
...
\section{Security}
	...
	\subsection{Types of Attacks}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item What is trap door? \hfill [2] (\bo{68 Bh})
		\end{enumerate}
	...
	\subsection{Protection Mechanisms}
		\begin{enumerate}[noitemsep, topsep=0pt]
			\item Protection Domains:
				\begin{enumerate}[noitemsep, topsep=0pt]
					\item Write short notes: Protection Domain \hfill [3] (\bo{80 Ch}, 75 Ba) [3.5] (73 Ma)
					\lb Explain protection domain. \hfill [2] (\texttt{82 Ba}) [2.5] (\bo{69 Ch})
					\lb Explain domain-object. \hfill [2] (\bo{70 Bh})
			...
			\item ACL:
				\begin{enumerate}
					\item What is ACL? \hfill [2] {\tiny (\bo{\texttt{81 Bh, 80 Bh}, 79 Ch, 77 Ch, 70 Bh}, \texttt{82 Ba, 81 Ba})} [2.5] {\tiny (\bo{69 Ch}, \texttt{80 Ba})} [3] {\tiny (\bo{68 Bh})}
