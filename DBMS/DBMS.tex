...
\section{File Structure and Hashing}
    ...
    \subsection{Disks, Storage, and RAID}
    		\begin{enumerate}[noitemsep, topsep=0pt]
    			\item What is RAID? \hfill [1] \begin{footnotesize}(\bo{\texttt{81 Bh}, 80 Ch, 77 Ch, 76 Bh, 71 Bh})\end{footnotesize}, \texttt{80 Ba}, 73 Ma) [3] \begin{footnotesize}(\bo{68 Bh}, 72 Ma)\end{footnotesize}
