...
\section{File Structure and Hashing}
    ...
    \subsection{Records Organizations}
		\begin{enumerate}[noitemsep, topsep=0pt]
			...
			\item Briefly explain Fixed Length Record and Variable Length Record and Variable Length record along with suitable examples. \hfill [4] (\bo{78 Ch})
		\end{enumerate}		    
    
    \subsection{Disks and Storage}
    		\begin{enumerate}[noitemsep, topsep=0pt]
    			\item What do you mean by RAID? \hfill [1] (\bo{\texttt{81 Bh}, 80 Ch}, \texttt{80 Ba})
    			
    			\item Explain different levels of RAID. \hfill [3] (\bo{\texttt{81 Bh}}) [4] (\bo{80 Ch})
    			
			\item Summarize the various levels of RAID and mention how to select an appropriate level of RAID. \hfill [3+1] (\bo{79 Ch})
    			
    			\item Explain the types of RAID and mention how to select an appropriate level of RAID. \hfill [4] (\texttt{80 Ba})
    ...
    \subsection{Order Indices}
    		\begin{enumerate}[noitemsep, topsep = 0pt]    			
    			...
    			\item What is the difference between ordered indices and hash indices in a database? \hfill [2] (\texttt{80 Ba})
    			
    			\item What is the advantages of using sparse index? \hfill [4] (\texttt{80 Ba})
    			
    			\item Differentiate between dense index and sparse index. \hfill [2] (\bo{79 Ch})
